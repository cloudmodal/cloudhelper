    ...
    var columnDefs = [
        {
            ...
            createdCell: function (td, cellData) {
                $(td).html('<input type="checkbox" class="text-center chk-col-light-blue ipt_check" id=99991937>'.replace('99991937', cellData));
            }
        },
        {
    ...
    var columnDefs = [
        {
            ...
            createdCell: function (td, cellData) {
                $(td).html('<input type="checkbox" class="text-center chk-col-light-blue ipt_check" id=99991937>'.replace('99991937', cellData) +
                    '<label for=99991937></label>'.replace('99991937', cellData));
            }
        },
        {
            targets: '_all',
