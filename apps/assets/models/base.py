...
from common.utils import (
    get_signer, ssh_key_string_to_obj,
    ssh_key_gen, get_logger
)
...
class AssetUser(OrgModelMixin):
    ...
    username = models.CharField(
        max_length=32, blank=True, verbose_name=_('Username'),
    ...
    private_key = fields.EncryptTextField(
        blank=True, null=True, verbose_name=_('SSH private key')
    )
    public_key = fields.EncryptTextField(
        blank=True, null=True, verbose_name=_('SSH public key')
    )
