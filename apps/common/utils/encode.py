...
def ssh_pubkey_gen(private_key=None, username='l2c', hostname='localhost', password=None):
...
def ssh_key_gen(length=2048, type='rsa', password=None, username='l2c', hostname=None):
